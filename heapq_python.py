# This is the python heapq implementation. Just for reference.
# There is one drawback of this heapq is that there is no delete method. Need to find the node in O(n).
